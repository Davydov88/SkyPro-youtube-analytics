...
class PlayList:
    ...
    def get_video_ids(self) -> list[str]:
        ...
        Returns: список строк с id видео
    ...
    def get_videos_duration(self) -> list[object]:
        """
        Метод получения длины каждого видео из плейлиста
        Returns: список объектов класса datetime.timedelta
    ...
    def total_duration(self) -> object:
        ...
        Returns: объект класса datetime.timedelta
    ...
    def show_best_video(self) -> str:
        ...
        Returns: строка с ссылкой на видео
